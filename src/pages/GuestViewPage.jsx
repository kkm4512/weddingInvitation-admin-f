...
export default function GuestViewPage() {
  ...
  return (
    <div className="min-h-screen bg-white max-w-md mx-auto">
      ...
      {/* 연락하기 */}
      {data?.contacts && data.contacts.filter(c => c.isVisible !== false).length > 0 && (
        <Section title="연락하기">
          <div className="space-y-2">
      ...
      {/* 방명록 */}
      {(guestbookSettings?.isEnabled !== false || messages.length > 0) && (
        <Section title="방명록">
          {/* 작성 폼 */}
